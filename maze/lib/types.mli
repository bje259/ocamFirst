type cell = Wall | Path
type maze = { width : int; height : int; grid : cell array array }
...
type solved_maze = { smaze : maze; solution : solution_path }
type 'a tree = Empty | Node of 'a tree * 'a * 'a tree
type 'a transformer = Identity | Function of ('a -> string)
